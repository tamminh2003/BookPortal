		...
		<table width='200' height='80' align='left'>
			...
			<c:forEach var="book" items="${listBook}">
				...
				<tr fontstyle="bold">
					...
					<td><b><a
							href="${pageContext.request.contextPath}/BookListServlet?action=edit&id=<c:out value='${book.getbid()}'/>"><c:out
									value="${book.getbooktitle()}" /></a></b></td>
				</tr>
				...
				<tr>
					<td><c:out value="${book.getdescription()}" />
						<hr></td>
				</tr>
